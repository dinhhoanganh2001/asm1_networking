...
class Client:
    ...
    def createWidgets(self):
        """Build GUI."""
        # Create Setup button
        self.setup = Button(self.master, width=30, padx=3, pady=3, activebackground = 'red', activeforeground = 'white'
                            , bg = 'yellow')
        ...
        # Create Play button
        self.start = Button(self.master, width=30, padx=3, pady=3, activebackground = 'red', activeforeground = 'white'
                            , bg = 'green')
        ...
        # Create Pause button
        self.pause = Button(self.master, width=30, padx=3, pady=3, activebackground = 'red', activeforeground = 'white'
                            , bg = 'red')
        ...
        self.teardown = Button(self.master, width=30, padx=3, pady=3, activebackground = 'red', activeforeground = 'white'
                            , bg = 'black', fg = 'white')
    ...
    def handler(self):
        ...
        self.pauseMovie()
        if tkM.askokcancel("Quit?", "Are you sure you want to quit?"):
            self.exitClient()
